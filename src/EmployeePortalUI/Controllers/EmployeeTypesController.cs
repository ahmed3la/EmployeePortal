...
namespace EmployeePortalUI.Controllers
{
    public class EmployeeTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EmpType")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmpType")] EmployeeType employeeType)
        {
